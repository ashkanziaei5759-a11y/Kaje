...
export default function OfflinePage() {
  return (
    <main className="grid min-h-screen place-items-center bg-ink-950 px-6 text-center">
      <div>
        <span className="mx-auto grid size-16 place-items-center rounded-2xl bg-ink-800 text-3xl font-extrabold text-saffron-400">
          ک
        </span>
        <h1 className="mt-5 text-xl font-bold text-ink-50">اتصال اینترنت قطع است</h1>
        ...
        <a
          href="/menu"
          className="mt-6 inline-flex min-h-11 items-center rounded-xl bg-saffron-400 px-6 text-sm font-bold text-ink-950"
        >
          تلاش دوباره
        </a>
      </div>
